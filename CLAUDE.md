...
- 内容: 運営者が「実際に確認・比較した」視点の15〜40文字コメント
- 医師・専門家属性（「外来で」「診療して」「患者さんに」）は**禁止**。「使ってみると」「比べてみると」「試してみると」文体
...
<AffiliateCard
  brand="GREEN SPOON"
  catchcopy="..."
  shopComment="液体で栄養が取れるので、食欲がわかない日のバックアップにちょうど良い"
  ...
/>

{/* ❌ 禁止（shopCommentなし・医師表現） */}
<AffiliateCard
  brand="GREEN SPOON"
  catchcopy="..."
  shopComment="外来でも患者さんに勧めています"
  ...
/>
```
